...
def get_user_taste_vector(swipes, history):
    ...
    @param swipes: list of swipes, each swipe is a dict with keys 'dish name' and 'swiped'
    @param history: list of swipes, each swipe is a dict with keys 'dish name', 'swiped', 'was_recommended', and 'timestamp'
    
    @return: a pandas dataframe with dish names as index and a single column 'wave_rating' with the taste vector"""
